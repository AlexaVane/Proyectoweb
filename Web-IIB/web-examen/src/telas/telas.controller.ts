...
//import { TelasService } from './actor.service';
...
//mport { ActorEntity } from './actor.entity';
...
export class TelasController {
    ...
    async crearA(
        ...
        producto = await this._telasService.findAll();
        let telas: TelasEntity[];


        telas = await this._telasService.findAll()
        res.render(
            'lista-actores', {
                arregloPeliculas: producto, // AQUI!
